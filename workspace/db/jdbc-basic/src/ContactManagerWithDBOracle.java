...
public class ContactManagerWithDBOracle {

	private java.util.Scanner scanner = new java.util.Scanner(System.in);

	private ContactDaoOracle dao = new ContactDaoOracle();
	
	public ContactManagerWithDBOracle() {}
	...
	public static void main(String[] args) {
		...
		ContactManagerWithDBOracle contactManager = new ContactManagerWithDBOracle();
